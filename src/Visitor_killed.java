 ...
 * @author AT
 */
public class Visitor_killed extends javax.swing.JFrame {
DefaultTableModel model;
    /**
     * Creates new form Visitor_killed
     */
    public Visitor_killed() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Visitor_killed.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Visitor_killed().setVisible(true);
            }
        });
    }
